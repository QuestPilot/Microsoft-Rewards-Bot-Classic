...
This feature is experimental and high risk. Microsoft commonly flags fresh accounts when they are used for Rewards automation too quickly.
...
3. Let new accounts rest for several weeks before earning points.
...
- Do not run Rewards immediately; wait 2-4 weeks before first automated earning.
